...
CNtpTime::operator NtpTimePacket() const
{
	NtpTimePacket ntp;
...
CNtpTime CNtpTime::GetCurrentTime()
{
	...
	//对时间结构体赋值
	st.wYear = cur_tm->tm_year + 1900;
	st.wMonth = cur_tm->tm_mon + 1;
	st.wDayOfWeek = cur_tm->tm_wday;
	st.wDay = cur_tm->tm_mday;
	st.wHour = cur_tm->tm_hour;
	st.wMinute = cur_tm->tm_min;
	st.wSecond = cur_tm->tm_sec;
	...
	printf("GetCurrentTime wYear %d\n", st.wYear);
	printf("GetCurrentTime wMonth %d\n", st.wMonth);
	printf("GetCurrentTime wDayOfWeek %d\n", st.wDayOfWeek);
	printf("GetCurrentTime wDay %d\n", st.wDay);
	printf("GetCurrentTime wHour %d\n", st.wHour);
	printf("GetCurrentTime wMinute %d\n", st.wMinute);
	printf("GetCurrentTime wSecond %d\n", st.wSecond);
	printf("=======================\n");
	*/
