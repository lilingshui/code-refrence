...
public:
	...
	virtual CString GetName() = 0; // return teacher name if in teacher side, otherwise return student name
...
public:
	...
	virtual CString GetCurrentClassModel() = 0;
	virtual BOOL EnumClassModel(LPCTSTR lpszAccount, CStringArray& arrClassModel) = 0;

	BOOL IsFullFunctionMode(){return TRUE;};
};
...
public:
	...
	virtual void GetMemberInfo(PMEMBERINFO pMemberInfo) = 0;
