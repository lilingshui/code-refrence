//LibElcBaseUi的使用
//LibElcBaseUi为公司的一个皮肤库，生成为一个动态
//链接库，使用起来也很简单
//首先要在工程中添加库的依赖，以及相应的头文件包含目录
//添加相应的头文件

//下面以一个对话框为例，来说明一下具体的使用
//在stdafx.h文件中:
...
//主要是添加CodeSnippets/teacherframe.h
//以及../../Libraries/LibElcBaseUI/export.h这两个头文件
...
class CTestDlg : public CElcSkinDialog//改成从CElcSkinDialog派生
{
public:
