...
/*
typedef union tagGROUPPARAMS
{
	 BROADCASTPARAMS	broadParams;
	 VOICETEACHPARAMS	voiceParams;
	 VOICETALKPARAMS	voiceTalkParams;
	 MONITORPARAMS		monitorParams;
	 MOVIEPARAMS		movieParams;
	 FILECASTPARAMS		fileCastParams;
	 GROUPDESTPARAMS	groupDestParams;
...
typedef struct tagGROUPCHATPARAMS
{
	DWORD dwIpAddress;
	WORD  wPort;
	BOOL  bGroupChat; // TRUE if is group chat, else is group call
